...
class _MyAppState extends State<MyApp> {
  ...
  final Color _brandColor = const Color(0xFF4E6629);
  ...
  Widget build(BuildContext context) {
    return DynamicColorBuilder(
      builder: (ColorScheme? lightDynamic, ColorScheme? darkDynamic) {
        // no dynamicColorAvailable bool in current dynamic_color version i think
        // just check for android and null
        bool isDynamicColorAvailable = lightDynamic != null &&
            darkDynamic != null &&
